...
enum MapFilter{NONE, MEDIAN};
enum ClosestFrames{TOP_LEFT=0, TOP_RIGHT=1, BOTTOM_LEFT=2, BOTTOM_RIGHT=3};
enum IntConstantIDs{IMG_RES_X=0, IMG_RES_Y, COLS, ROWS, GRID_SIZE, DISTANCE_ORDER, SCAN_METRIC, FOCUS_METHOD, MAP_FILTER, CLOSEST_VIEWS, BLOCK_SAMPLING, YUV_DISTANCE, CLOCK_SEED, BLEND_ADDRESS_MODE, INT_CONSTANTS_COUNT};
enum FloatConstantIDs{SCAN_RANGE, SPACE, DESCENT_START_STEP, FOCUS_METHOD_PARAMETER, PYRAMID_BROAD_STEP, PYRAMID_NARROW_STEP, PX_SIZE_X, PX_SIZE_Y, DOF_DISTANCE, DOF_WIDTH, DOF_MAX, FLOAT_CONSTANTS_COUNT};
...
enum FileNames {FOCUS_MAP=0, FOCUS_MAP_POST, RENDER_IMAGE, RENDER_IMAGE_POST, OUTPUT_COUNT};
