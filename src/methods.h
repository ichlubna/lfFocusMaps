...
enum ScanSpace{LINEAR};
enum ClosestFrames{TOP_LEFT=0, TOP_RIGHT=1, BOTTOM_LEFT=2, BOTTOM_RIGHT=3};
enum ConstantIDs{IMG_RES_X=0, IMG_RES_Y, COLS, ROWS, GRID_SIZE, DISTANCE_ORDER, SCAN_SPACE, SCAN_METRIC, FOCUS_METHOD, FOCUS_METHOD_PARAMETER, CLOSEST_VIEWS, BLOCK_SAMPLING, RANGE, CONSTANTS_COUNT};
