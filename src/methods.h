...
enum FloatConstantIDs{SCAN_RANGE, SPACE, DESCENT_START_STEP, FOCUS_METHOD_PARAMETER, PYRAMID_BROAD_STEP, PYRAMID_NARROW_STEP, PX_SIZE_X, PX_SIZE_Y, FLOAT_CONSTANTS_COUNT};
