...
enum FloatConstantIDs{SCAN_RANGE_START, SCAN_RANGE_END, SCAN_RANGE_SIZE, SPACE, DESCENT_START_STEP, FOCUS_METHOD_PARAMETER, PYRAMID_BROAD_STEP, PYRAMID_NARROW_STEP, PX_SIZE_X, PX_SIZE_Y, DOF_DISTANCE, DOF_WIDTH, DOF_MAX, MIST_START, MIST_END, MIST_COLOR, FLOAT_CONSTANTS_COUNT};
